...
const EVENTS = [
    {
        event_id: 'e1',
        client_id: 'lab-02',
        exam_session_id: 'sess-2',
        category: 'focus_lost',
        severity: 'warning',
        message: '考生窗口失焦超过 30 秒',
        occurrence_count: 3,
        status: 'open',
        first_seen_at: iso(600),
        last_seen_at: iso(60),
    },
    {
        event_id: 'e2',
        client_id: 'lab-05',
        exam_session_id: 'sess-4',
        category: 'screen_unlocked',
        severity: 'critical',
        message: '锁屏模式被解除',
        occurrence_count: 1,
        status: 'open',
        first_seen_at: iso(900),
        last_seen_at: iso(900),
    },
    {
        event_id: 'e3',
        client_id: 'lab-01',
        exam_session_id: 'sess-1',
        category: 'clipboard_paste',
        severity: 'info',
        message: '检测到剪贴板粘贴',
        occurrence_count: 2,
        status: 'open',
        first_seen_at: iso(180),
        last_seen_at: iso(20),
    },
    {
        event_id: 'e4',
        client_id: 'lab-03',
        exam_session_id: 'sess-3',
        category: 'usb_attached',
        severity: 'warning',
        message: 'USB 存储设备插入',
        occurrence_count: 1,
        status: 'resolved',
        first_seen_at: iso(1400),
        last_seen_at: iso(1400),
    },
    {
        event_id: 'e5',
        client_id: 'lab-06',
        exam_session_id: 'sess-5',
        category: 'process_spawn',
        severity: 'info',
        message: '检测到外部进程启动: Chrome',
        occurrence_count: 5,
        status: 'open',
        first_seen_at: iso(300),
        last_seen_at: iso(5),
    },
];
...
const APPROVALS = [
    {
        id: 'a1',
        machine_id: 'lab-04',
        oj_contest_id: '6a0d8d4b778ff4a7dc9452ac',
        student_id_input: '202301010',
        real_name_input: '王五',
        matched_oj_user_id: null,
        is_unknown: true,
        status: 'pending',
        created_at: iso(120),
    },
    {
        ...
        machine_id: 'lab-07',
        oj_contest_id: '6a0d8d4b778ff4a7dc9452ac',
        student_id_input: '202301011',
        real_name_input: '赵六',
        matched_oj_user_id: 102,
        is_unknown: false,
        status: 'pending',
        created_at: iso(45),
    },
    {
        ...
        machine_id: 'lab-02',
        oj_contest_id: '6a0d8d4b778ff4a7dc9452ac',
        student_id_input: '202301002',
        real_name_input: '李四',
        matched_oj_user_id: 100,
        is_unknown: false,
        status: 'approved',
        created_at: iso(800),
    },
...
const SESSIONS = [
    ...
    },
    {
        ...
        machine_id: 'lab-01',
        oj_user_id: 100,
        oj_contest_id: '6a0e6af09e257f9787c4985d',
        status: 'closed',
        began_at: iso(8400),
        closed_at: iso(2400),
        is_temporary_user: false,
