...
export interface SelectProps extends Omit<React.ComponentPropsWithoutRef<typeof RSelect.Root>, 'value' | 'defaultValue' | 'onValueChange' | 'name'> {
  value?: string;
  defaultValue?: string;
 ...
 */
export function Select({ value, defaultValue, onValueChange, name, children, ...props }: SelectProps) {
...
export const SelectContent = React.forwardRef<React.ElementRef<typeof RSelect.Content>, React.ComponentPropsWithoutRef<typeof RSelect.Content>>(
...
export interface SelectItemProps extends Omit<React.ComponentPropsWithoutRef<typeof RSelect.Item>, 'value'> {
  value: string;
}
