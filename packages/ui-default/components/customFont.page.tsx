...
export default new AutoloadPage(
  'customFont',
  (pageName) => {
    let dialog;
    let selection = '';
      ...
      return (
        <div className="medium-6 columns">
          <label>
            {i18n(props.label)}
            <div>
              <button className="button inline" data-show-font-dialog={props.saveKey}>
    ...
    if (pageName === 'home_preference' && 'queryLocalFonts' in window) {
      $('[name="form_item_fontFamily"]')
        .parent()
        .parent()
        .parent()
        .append($(tpl(<FontSelectButton saveKey="customFont" label="Select Custom Font" value={customFont} />)));
      $('[name="form_item_codeFontFamily"]')
        .parent()
        .parent()
        .parent()
        .append($(tpl(<FontSelectButton saveKey="customCodeFont" label="Select Custom Code Font" value={customCodeFont} />)));
