          ...
          {sections.map((section) => {
            ...
            return (
              <div key={section.key} className="space-y-1">
                <h3 className="px-2 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">{section.label}</h3>
                      ...
                      <li key={item.key}>
                        <a
                          ...
                          className={cn(
                            ...
                            active ? 'bg-primary/10 font-medium text-primary' : 'text-foreground/70 hover:bg-accent hover:text-foreground',
                          )}
                        >
