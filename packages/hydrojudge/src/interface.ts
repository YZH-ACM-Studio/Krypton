import { DetailType, JudgeResultBody, type LangConfig, NormalizedSubtask, ProblemConfigFile } from '@hydrooj/common';
...
export interface Session {
    ...
    getReporter: (task: JudgeTask) => { next: NextFunction; end: NextFunction; wait?: () => Promise<void> };
