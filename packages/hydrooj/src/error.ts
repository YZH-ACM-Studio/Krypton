...
export const ContestClientRequiredError = Err('ContestClientRequiredError', ForbiddenError, 'This contest must be entered through the Qt Client.');
export const ContestClientFinishedError = Err('ContestClientFinishedError', ForbiddenError, 'You have actively ended this contest on the Qt Client.');
...
export const AccountStateConflictError = Err(
