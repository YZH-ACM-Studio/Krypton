    ...
    antfu(
        {
            ...
            ...option,
            gitignore: false,
            ignores: ['**/*.d.ts', '**/.git', '**/.pnp.*', ...(option.ignores || [])],
            languageOptions: {
                globals: {
                    Atomics: 'readonly',
                    BigInt: 'readonly',
            ...
            ? [
                  {
                      ...
                      rules: {
                          'vue/block-order': [
                              'warn',
                              { order: ['template', 'script[setup]', 'script:not([setup])', 'style[scoped]', 'style:not([scoped])'] },
                          ],
