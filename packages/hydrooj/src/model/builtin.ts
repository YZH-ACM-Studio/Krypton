...
export const PERMS = [
    ...
    Permission('perm_collect', PERM.PERM_CREATE_COLLECT, 'Create file collections'),
    Permission('perm_collect', PERM.PERM_MANAGE_COLLECT, 'Manage all file collections in this domain'),
];
